...
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
glColor3f(0,0,0);
drawstring(2.5,2.65,0.0,"MACHAKOS BUILDING");
//Earth
glPushMatrix();
glColor3f(0.5,0.5,1.5);
glScaled(0.8,1,0.8);
...
glColor3f(0,0,0);
drawstring(-3.5,-3,0.0,"7. Type of Connection : Point-to-Point & Multi-point");
glFlush();
glutSwapBuffers();
}
void s()
...
drawstring(-3,3.0,0.0,"DEPARTMENT OF COMPUTING INFORMATION TECHNOLOGY");
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
glColor3f(0.0,1.0,1.0);
drawstring(-3.0,2.5,0.0,"COMPUTER GRAPHICS :DATA COMMUNICATION IN NETWORK");
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
glColor3f(0.0,1.0,1.0);
...
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
glColor3f(0.0,1.0,1.0);
drawstring(-2,1,0,"GROUP THREE MEMBERS");
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
glColor3f(0.0,1.0,1.0);
drawstring(-2,0.5,0,"GEORGE MWAURA");
drawstring(-2,0.1,0,"DENNIS MWAI");
drawstring(-2,-0.3,0,"MICHAEL MAINA");
drawstring(-2,-0.7,0,"PETER MIANO");
drawstring(-2,-1.1,0,"SAMUEL MUTISO");
stroke_output(-2.0,-1.9, "s-->Start");
stroke_output(-2.0, -2.5, "A-->About");
stroke_output(-2.0, -3.0,"q-->Quit");
